...
private:
    ...
    void setupTranslations() {
        ...
        m_en["  (não registrado)"] = "  (unregistered)";
        m_en["Registrar este usuário"] = "Register this user";
        m_en["Registrar usuário"] = "Register user";
        m_en["Mostrar descrição e informações do servidor"] = "Show server description and information";
        m_en["Registrado"] = "Registered";
        m_en["Não registrado"] = "Unregistered";
        m_en["Cargos:"] = "Roles:";
        m_en["Registro:"] = "Registration:";
        ...
        m_es["  (não registrado)"] = "  (no registrado)";
        m_es["Registrar este usuário"] = "Registrar este usuario";
        m_es["Registrar usuário"] = "Registrar usuario";
        m_es["Mostrar descrição e informações do servidor"] = "Mostrar descripción e información del servidor";
        m_es["Registrado"] = "Registrado";
        m_es["Não registrado"] = "No registrado";
        m_es["Cargos:"] = "Cargos:";
        m_es["Registro:"] = "Registro:";
